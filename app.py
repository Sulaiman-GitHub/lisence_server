...
# Use Environment Variable for the Database URL (Supabase/Render Postgres)
...
if __name__ == '__main__':
    # On Render, init_db is better called during deployment or manually
    # but we can keep it here for simplicity
    if DATABASE_URL:
        init_db()
